				...
				<div class="dialog-body">
					...
					<div class="dialog-body">
						<div class='p-2'>
							...
							<div class='abc input'>
								<input type='text' data-role='input' data-prepend='Logo' placeholder='Logo' data-validate='minlength=5' data-role-input='true' name='logo'>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="dialog-body">
					...
					<div class="dialog-body">
						<div class='p-2'>
							...
							<div class='abc textarea'>
								<textarea data-prepend='Deskripsi' placeholder='Deskripsi' data-validate='minlength=5' name='deskripsi'>{{ $tokos->desckripsi }}</textarea>
							</div>
							<div class='abc input'>
							...
							<div class='abc input'>
								<input type='text' data-role='input' data-prepend='Logo' placeholder='Logo' data-validate='minlength=5' data-role-input='true' name='logo' value="">
							</div>
						</div>
					</div>
				</div>
